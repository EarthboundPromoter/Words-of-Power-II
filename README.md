...
guide, current through 0.6.3 — covers what moved, what changed, and what's new, with a
...
3. Launch the game. You'll hear "Words of Power version 0.6.3" if it's working. A debug
...
| **P** | Path to your attention point, and it names which one: "path to cursor" in Look mode, "path to aim" while aiming a spell, "path to destination" for teleports. With no cursor up, the path to the last scanned target instead — nothing pinned, nothing moved. Scan, hear a target, P for the route, keep scanning. |
